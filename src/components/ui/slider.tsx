      ...
      <>
        ...
        >
          <SliderPrimitive.Track
            className={cn(
              "bg-secondary [&>span]:bg-primary relative h-full w-full grow overflow-hidden rounded-full",
            )}
          >
            <SliderPrimitive.Range
              data-state="range"
              className={cn("range absolute", {
            ...
            return (
              <>
                {showTooltip ? (
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <SliderPrimitive.Thumb
                          key={`thumb-${index}`}
                          className="range-thumb ring-offset-background block h-5 w-5 cursor-pointer rounded-full border-2 transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50"
                        />
                      </TooltipTrigger>
                  ...
                  <SliderPrimitive.Thumb
                    key={`thumb22-${index}`}
                    className="range-thumb ring-background ring-offset-background block h-5 w-5 cursor-pointer rounded-full ring-2 transition-colors focus-visible:ring-4 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50"
                  />
                )}
              </>
            );
