...
export const textareaVariants = cva(
  " w-full   bg-background  border-zinc-300 min-h-[80px] px-3 h-9  file:border-0 file:bg-transparent  file:font-medium  read-only:leading-9 read-only:bg-background  disabled:cursor-not-allowed disabled:opacity-50  transition duration-300 ",
  {
    variants: {
      color: {
        default:
