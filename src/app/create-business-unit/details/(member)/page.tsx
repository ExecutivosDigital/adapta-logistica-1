...
export default function BranchesList() {
  ...
  return (
    <div className="grid w-full grid-cols-2 gap-4">
      ...
      <div className="flex h-full w-full flex-col rounded-t-lg border border-zinc-200 border-b-transparent shadow-lg">
        <div className="flex w-full flex-col border-b-zinc-200 p-8">
          <span className="text-lg font-semibold">
            Dados da Unidade de Negócios
          </span>
          <span className="text-zinc-400">Responsável pela Unidade</span>
        </div>
      </div>
    </div>
  );
