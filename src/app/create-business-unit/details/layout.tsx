...
export default function RegisterLayout({
  ...
  const routes = [
    {
      id: "1",
      name: "Membros Unidade",
      route: "/create-business-unit/details",
    },
    {
      id: "2",
      name: "Centro de Custos",
      route: "/create-business-unit/details/cost-center",
    },
  ];
                  ...
                  <div className="flex items-center gap-8">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <div className="hover:border-primary-dark border-primary flex cursor-pointer items-center gap-2 rounded-lg border p-2 transition duration-300">
