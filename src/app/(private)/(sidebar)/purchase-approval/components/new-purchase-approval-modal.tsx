      ...
      {isModalOpen && (
        ...
        >
          ...
          <div className="relative z-50 flex max-h-[85vh] w-max flex-col items-center justify-center">
            <div
              className={twMerge(
                "relative z-20 flex w-full max-w-[50vw] flex-col items-center justify-start overflow-hidden rounded-md border bg-white px-2 shadow-md",
                "scrollbar-hide h-[85vh] w-[50vw] overflow-y-scroll rounded-2xl border-none px-0",
              )}
            >
              ...
              <div className="flex h-full w-full justify-between bg-[#FCF0EA]">
                <div className="flex h-full w-[45%] flex-col items-start justify-start bg-white shadow-[0_-1px_10px_0_rgba(0,0,0,0.2)]">
                ...
                <div className="flex h-full w-1/2 flex-col items-start justify-start bg-white shadow-[0_-1px_10px_0_rgba(0,0,0,0.2)]">
                  <div className="flex h-full w-full flex-col gap-4 px-6 pt-2 pb-6 text-zinc-400">
                    <div className="flex w-full items-center justify-between text-black">
                      <span className="font-semibold">Aprovação de Compra</span>
                      <div className="flex items-center gap-2">
              ...
              <div className="flex h-20 w-full items-center justify-between border-t border-t-zinc-200 p-4 shadow-[0_-1px_10px_0_rgba(0,0,0,0.1)]">
                ...
                <div className="flex items-center gap-4">
                  <button className="rounded-lg border border-zinc-200 bg-white px-4 py-2 font-semibold text-black">
                    Rejeitar
                  </button>
                  <button className="bg-primary rounded-lg border border-transparent px-4 py-2 font-semibold text-white">
                    Aprovar
                  </button>
                </div>
              </div>
